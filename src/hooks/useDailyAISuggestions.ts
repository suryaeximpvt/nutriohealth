      ...
      breakfast: {
        ...
        alternatives: [
          ...
          },
          {
            ...
            description: "Quick protein boost with Vellyn Protein Pancake Mix topped with banana",
      ...
      snacks: {
        ...
        alternatives: [
          ...
          },
          {
            ...
            description: "Quick protein with Vellyn Protein Bar - great on-the-go",
  ...
  return {
    breakfast: {
      ...
      alternatives: [
        ...
        {
          name: "AI alternative using Vellyn Overnight Oats Cup",
          description: "Convenient high-protein breakfast with Vellyn Overnight Oats Cup",
          nutrioProduct: "Vellyn Overnight Oats Cup",
          calories: 310,
          protein: 20,
          carbs: 38,
          fat: 10,
    ...
    snacks: {
      ...
      alternatives: [
        ...
        {
          name: "AI alternative using Vellyn Shake Sachet",
          description: "Quick protein shake with Vellyn Shake Sachet - mix and go",
          nutrioProduct: "Vellyn Shake Sachet",
          calories: 150,
          protein: 20,
          carbs: 12,
          fat: 3,
