...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Tools for Vellyn, a UK nutrition and fitness coach app. Use `get_daily_summary` for today's calories, macros, water and workouts against the user's targets, `get_progress` for weight and calorie trends, and the `log_*` tools to record food, water, workouts and body weight for the signed-in user.",
